...
class RegisterForm(FlaskForm):
    ...
    password = PasswordField(u'密碼',validators=[DataRequired(message=u'密碼不可為空'), Length(max=64,message=u"密碼過長"), Length(min=3,message=u"密碼過短"),Regexp('[a-zA-Z0-9]+',message="格式錯誤")])
