...
def cancelmyorder(CancelMyOrder_Form, searchShops, shop_product, Shop_Form, Product_Form, searchMyOrder0, searchMyOrder1, searchMyOrder2, searchMyOrder3, searchShopOrder0, searchShopOrder1, searchShopOrder2, searchShopOrder3, searchTransactionRecord0, searchTransactionRecord1, searchTransactionRecord2, searchTransactionRecord3, Location_Form, Recharge_Form):
    # TODO: edit this file
    ...
    if delete_order.status == "Cancelled":
        flash("失敗，訂單已被取消",category="my_cancel_failed")
    ...
    if delete_order.status == "Finished":
        flash("失敗，訂單已被完成",category="my_cancel_failed")
        return render_template(
                            "nav.html", 
                            # old version is outerjoin in next line
                            shop_product = shop_product,
    ...
    new_transaction1 = Transaction(uid, "Receive", end_time, sname, total_price)
    new_transaction2 = Transaction(obj_uid, "Payment", end_time, uname, total_price)
    ...
    flash("訂單取消成功",category="my_cancel_success")
    return render_template(
                            "nav.html",
                            # old version is outerjoin in next line
                            shop_product = shop_product,
