...
def cancelshoporder(CancelShopOrder_Form, searchShops, shop_product, Shop_Form, Product_Form, searchMyOrder0, searchMyOrder1, searchMyOrder2, searchMyOrder3, searchShopOrder0, searchShopOrder1, searchShopOrder2, searchShopOrder3, searchTransactionRecord0, searchTransactionRecord1, searchTransactionRecord2, searchTransactionRecord3, Location_Form, Recharge_Form):
    # TODO: edit this file
    ...
    new_transaction1 = Transaction(uid, "Payment", end_time, uname, total_price)
    new_transaction2 = Transaction(obj_uid, "Receive", end_time, sname, total_price)
